...
__global__ void build_bvh_NR_ROPE8(BVHNode* nodes, hittable* hittables, size_t N) {
    ...
    traversalStack[++top] = {0, N, root_index, -1, true, -1};  // {start, end, nodeIndex, parentIndex, isLeftChild, ropeIndex}
